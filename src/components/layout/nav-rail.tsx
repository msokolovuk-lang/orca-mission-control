...
interface NavItem {
  ...
  /** When true, item is reachable via URL / deep links but omitted from the sidebar. */
...
const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'super-admin', label: 'Super Admin', icon: <SuperAdminIcon />, priority: false, sidebarHidden: true },
    ],
  },
]
  ...
  function filterItems(items: NavItem[]): NavItem[] {
    return items
      .map(i => {
        ...
        if (i.sidebarHidden) return null
